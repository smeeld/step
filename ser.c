...
if((sock=socket(AF_INET,SOCK_RAW,IPPROTO_TCP))<0){  exit(-1);};
                      ...
                      if(s>1024){
                       ...
                       set_non_bl(s);
                          ...
                          continue; 
                           ...
                           else{ if(events[i].events & EPOLLIN){ printf("NEW CONNmm\n"); read_s(conn2); continue; }else{ write_s(conn2); continue; };
                                  };
