...
/*glFrustum(-2.0, 2.0, -1.0, 1.0, 1.0, 10.0);*/
...
int s2=atoi(s[2]);
shift=0;
models=(struct model*)malloc(sizeof(struct model)*4);
models[0].texfile="/home/g/m.jpg";
 models[0].size=s1*s1;
  models[1].size=s2*s2;
models[1].texfile="/home/g/s.jpg";
models[2].texfile="/home/g/s4.jpg";
 models[2].size=s1*s1;
  models[3].size=s2*s2;
models[3].texfile="/home/g/l.jpg";
 Sp(models,0);
 Par(models,1);
Sp(models,2);
 Par(models,3);
